...
const Repo_1 = __importDefault(require("../../lib/mongoose/models/Repo"));
function getRepos(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const repos = yield Repo_1.default.find().select('-address -email').limit(limit).skip(limit * page);
...
function getUniqueTechStacks(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const repos = yield Repo_1.default.find().select('techStack');
            let techStacks = [];
            repos.forEach((repo) => {
